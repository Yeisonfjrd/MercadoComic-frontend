      ...
      {result === null || result.length === 0 ? (
        ...
        result.map((product: { 
          ...
          return (
            ...
            >
              <div className="p-4 transition-transform transform group-hover:scale-105 h-full">
                <Card className="h-full flex flex-col justify-between py-4 border border-[hsl(var(--border))] shadow-md bg-[hsl(var(--card))] text-[hsl(var(--card-foreground))] p-2 group-hover:shadow-[0_4px_12px_hsl(var(--ring)/0.5)] rounded-[var(--radius)] transition-all duration-300">
                  <CardContent className="relative flex flex-col items-center justify-center px-6 py-4">
                    {images?.length > 0 ? (
                      <img
                        ...
                        className="rounded-lg shadow-md w-full h-64 object-cover transition-transform duration-300 group-hover:scale-105"
                      />
                    ) : (
                  ...
                  <div className="mt-4 px-6">
                    <h3 className="text-lg font-bold text-[hsl(var(--foreground))] line-clamp-2">
                      {productName}
                    </h3>
